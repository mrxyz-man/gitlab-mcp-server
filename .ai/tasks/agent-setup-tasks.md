...
- [x] Добавить regression test suite для модульного API и seamless OAuth.
- [x] Обновить пользовательскую и внутреннюю документацию.
- [x] Применить отдельный risk plan перед merge.
