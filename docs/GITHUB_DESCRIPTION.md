...
MCP server for GitLab with OAuth auto-login, token refresh, issue and label tools for AI agents.
...
`mcp`, `model-context-protocol`, `gitlab`, `oauth2`, `ai-agents`, `typescript`, `nodejs`
